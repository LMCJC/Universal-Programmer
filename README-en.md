...
for SPI and CAN communication between pc and hardware. For your own model railway projects!
...
*Once gnome-terminal is installed, you can run the application via the starter link **LMCJC Programmer Linux** in the program folder by double-clicking!*<br><br>
